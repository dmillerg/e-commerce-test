...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, DropdownComponent, SortPipe, SearchPipe, ProductCardComponent, PaginatorComponent, AccordionComponent, ProductSkeletonComponent],
